    ...
    $result_book = mysqli_query($conn, $sql_book);
        ...
        ?>
            ...
            <?php 
                ...
                $sqlBookid = "SELECT bookid,statusbook FROM `bookborrow` where statusbook = 0";
                $result1 = mysqli_query($conn, $sql1);
                $resultBookid = mysqli_query($conn, $sqlBookid);
             ?>
            <select style="width: 800px;" class="select2-single" id="bookid" name="bookid" onchange="showUser(this.value)" >
     ...
     <!--  <div id="txtHint"></div> -->
        ...
        ?> 
            ...
            วันที่ยืม : <input type="text" id="borrowdate" name="borrowdate" class="datepicker" 
