        ...
        <div id="page-wrapper" style="background-image: url('test-img.png');">
            <div class="row">
                ...
                <?php 
                  ...
                  // echo "จำนวนวันที่เลยส่ง : ". $DateNum ."<br>";
...
<div>
                <?php  if(isset($_GET['booktype'])){ 
                   ...
                   <form action="borrowbook.php" method="GET">
                    <div class="row" style="margin-left: 0px;margin-bottom: 15px;width: 1107px;height: 73px;">                      

                        <h4>ค้นหาเล่มโครงงาน...</h4>
                        <div class="col-lg-3" style="height: 33px;">
                        <select name="booktypeid" class="form-control" style="width: 260px;">

                              <option value="" <?php if(@$_GET['booktypeid']==''){ ?> selected <?php  } ?>>ประเภทเล่มทั้งหมด</option>
                ...
                <?php  } ?>
                       ...
                       <input type="hidden" name="submit" value="y"> 
                        <button type="submit" class="btn btn-success" style="padding-right: 40px;padding-left: 40px;">
        ...
        <tr>
            ...
            <td align="center">
              <label>
                <div class="checkbox" style="width: 85px;height: 35px;">
        ...
        ?>
            ...
            <button type="submit" class="btn btn-primary" style="padding-right: 40px;padding-left: 40px;">ยืนยัน</button>
            </div>
            </div>
             <input type="hidden" name="memberid" value="<?php echo $_SESSION['memberid'];?>">
             <br>
             <p style="color: red">***ผู้ยืมจะต้องคืนเล่มโครงงานภายในเวลาที่กำหนดไว้ </p>
          </form>
