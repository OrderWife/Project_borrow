...
function fncSubmit() {
  if(document.form1.booktype.value == "") {
alert('กรุณากรอกประเภทเล่มโครงงาน');
document.form1.booktype.focus();
return false;
}   
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading" style="height: 42px;background-color: #d7efd3">
                            <h4  style="margin-top: 0px;">รายการประเภทเล่มโครงงาน</h4>
                            <button class="btn btn-primary" style="margin-left: 75%;margin-top: -60px" 
                            data-toggle="modal" data-target="#myModal1"><span class="glyphicon glyphicon-plus" aria-hidden="true"> เพิ่มข้อมูลประเภทเล่มโครงงาน</span></button>
                        </div>
                        <!-- /.panel-heading -->
