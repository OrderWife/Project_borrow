      ...
      if ($advisorid == "all") {
        ...
        if ($year == "all") {
          ...
          if ($booknamethai == "") {
            ...
            $sqlq = "SELECT * FROM book left join advisor on book.advisorid = advisor.advisorid 
            WHERE booknamethai LIKE '%".$booknamethai."%'  ";
          } 
        }else{
          // echo $year;
...
?>
<?php 
  $sql_borrow = "SELECT * FROM `borrower` ORDER BY `borrower`.`borrowerid` DESC";
...
<div>
       ...
       $i++; } } 
        ...
        ?>
            ...
            <input type="text" name="borrowerid" value="<?php echo $row_borrower['borrowerid']+1; ?>">
          </form>
