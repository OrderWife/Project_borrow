                   ...
                   <table width="100%" class="table table-striped table-bordered table-hover" >
                                <thead>
                                    <tr class="header">
                                        ...
                                        <th width="18%"><center>จำนวนที่ยืม(ครั้ง)</center></th>
...
$row = 5 ;
    @$face = $_GET['face'];
    if($face==""){ $face=1; }
    $total_data = mysqli_num_rows(mysqli_query($conn,"SELECT * FROM book"));
...
INNER JOIN booktype ON book.booktypeid=booktype.booktypeid ORDER BY  `book`.`bookid` DESC";
...
$result = mysqli_query($conn, $sql);
        ...
        <tr>
            ...
            <input type="hidden" name=""
             ...
             <?php  echo $row['bookid']; ?>.
             <?php  echo $row['fname_stu']; ?>.
             <?php  echo $row['lname_stu']; ?>.
             <?php  echo $row['fname']; ?>.
             <?php  echo $row['lname']; ?>.
  ...
  <ul class="pagination">
    ...
    <li><a href="index2.php?face=<?php echo "$i"; ?>"><?php echo "$i"; ?></a></li>
    <?php } ?>
    <li>
