...
<h3 align="center">เข้าสู่ระบบ(สำหรับสมาชิก)</h3>
  <div class="w3-code notranslate htmlHigh">
	<form  action="insert_login.php" method="post" name="form1" onSubmit="JavaScript:return fncSubmit();" >
            ...
            <a href="pj_signup.php">ลงทะเบียน </a> | <a href="pj_login_staff.php">สำหรับเจ้าหน้าที่</a>
            </center>
